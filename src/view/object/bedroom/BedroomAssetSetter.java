...
public class BedroomAssetSetter extends AssetSetter {
    ...
    public void setObject() {
        ...
        gp.obj[0] = new OBJ_Kitchen("side-table-girl", "/rooms/bedroom/bedroom_OBJ/side-table-girl.png",14,21);
        gp.obj[0].screenX = 22 * 3;
        gp.obj[0].screenY = 50 * 3;

        gp.obj[1] = new OBJ_Kitchen("side-table-girl", "/rooms/bedroom/bedroom_OBJ/side-table-girl.png",14,21);
        gp.obj[1].screenX = 51 * 3;
        gp.obj[1].screenY = 50 * 3;

        gp.obj[2] = new OBJ_Kitchen("girl-bed", "/rooms/bedroom/bedroom_OBJ/girl-bed.png",15,26);
        gp.obj[2].screenX = 36 * 3;
        gp.obj[2].screenY = 56 * 3;

        gp.obj[3] = new OBJ_Kitchen("girl-toys", "/rooms/bedroom/bedroom_OBJ/girl-toys.png",16,13);
        gp.obj[3].screenX = 66 * 3;
        gp.obj[3].screenY = 58 * 3;

        gp.obj[4] = new OBJ_Kitchen("boy-toys", "/rooms/bedroom/bedroom_OBJ/boy-toys.png",16,13);
        gp.obj[4].screenX = 149 * 3;
        gp.obj[4].screenY = 56 * 3;

        gp.obj[5] = new OBJ_Kitchen("door", "/rooms/bedroom/bedroom_OBJ/door.png",24,30);
        gp.obj[5].screenX = 219 * 3;
        gp.obj[5].screenY = 35 * 3;

        gp.obj[6] = new OBJ_Kitchen("boy-bed", "/rooms/bedroom/bedroom_OBJ/boy-bed.png",15,27);
        gp.obj[6].screenX = 180 * 3;
        gp.obj[6].screenY = 55 * 3;

        gp.obj[7] = new OBJ_Kitchen("bird", "/rooms/bedroom/bedroom_OBJ/bird.png",15,33);
        gp.obj[7].screenX = 19 * 3;
        gp.obj[7].screenY = 151 * 3;

        gp.obj[8] = new OBJ_Kitchen("car-mat", "/rooms/bedroom/bedroom_OBJ/car-mat.png",34,18);
        gp.obj[8].screenX = 159 * 3;
        gp.obj[8].screenY = 165 * 3;
        gp.obj[8].collision = false;

        gp.obj[9] = new OBJ_Kitchen("heart-rug", "/rooms/bedroom/bedroom_OBJ/heart-rug.png",32,26);
        gp.obj[9].screenX = 99 * 3;
        gp.obj[9].screenY = 109 * 3;
        gp.obj[9].collision = false;

        gp.obj[10] = new OBJ_Kitchen("play-desk", "/rooms/bedroom/bedroom_OBJ/play-desk.png",36,17);
        gp.obj[10].screenX = 201 * 3;
        gp.obj[10].screenY = 152 * 3;

        gp.obj[11] = new OBJ_Kitchen("play-chair", "/rooms/bedroom/bedroom_OBJ/play-chair.png",10,16);
        gp.obj[11].screenX = 216 * 3;
        gp.obj[11].screenY = 135 * 3;

        gp.obj[12] = new OBJ_Kitchen("cloud-plush", "/rooms/bedroom/bedroom_OBJ/cloud-plush.png",18,12);
        gp.obj[12].screenX = 218 * 3;
        gp.obj[12].screenY = 146 * 3;

        gp.obj[13] = new OBJ_Kitchen("car-toy", "/rooms/bedroom/bedroom_OBJ/car-toy.png",18,14);
        gp.obj[13].screenX = 182 * 3;
        gp.obj[13].screenY = 169 * 3;

        gp.obj[14] = new OBJ_Kitchen("football", "/rooms/bedroom/bedroom_OBJ/football.png",15,10);
        gp.obj[14].screenX = 191 * 3;
        gp.obj[14].screenY = 83 * 3;

        gp.obj[15] = new OBJ_Kitchen("side-table-boy", "/rooms/bedroom/bedroom_OBJ/side-table-boy.png",14,20);
        gp.obj[15].screenX = 166 * 3;
        gp.obj[15].screenY = 50 * 3;

        gp.obj[16] = new OBJ_Kitchen("side-table-boy", "/rooms/bedroom/bedroom_OBJ/side-table-boy.png",14,20);
        gp.obj[16].screenX = 195 * 3;
        gp.obj[16].screenY = 50 * 3;

        gp.obj[17] = new OBJ_Kitchen("white-chest", "/rooms/bedroom/bedroom_OBJ/white-chest.png",28,17);
        gp.obj[17].screenX = 103 * 3;
        gp.obj[17].screenY = 52 * 3;

        gp.obj[18] = new OBJ_Kitchen("dragon-plush", "/rooms/bedroom/bedroom_OBJ/dragon-plush.png",13,16);
        gp.obj[18].screenX = 66 * 3;
        gp.obj[18].screenY = 48 * 3;

        gp.obj[19] = new OBJ_Kitchen("giraffe-plush", "/rooms/bedroom/bedroom_OBJ/giraffe-plush.png",15,16);
        gp.obj[19].screenX = 149 * 3;
        gp.obj[19].screenY = 42 * 3;

        gp.obj[20] = new OBJ_Kitchen("stack-toy", "/rooms/bedroom/bedroom_OBJ/stack-toy.png",16,14);
        gp.obj[20].screenX = 38 * 3;
        gp.obj[20].screenY = 170 * 3;

        gp.obj[21] = new OBJ_Kitchen("sketch-toy", "/rooms/bedroom/bedroom_OBJ/sketch-toy.png",18,15);
        gp.obj[21].screenX = 228 * 3;
        gp.obj[21].screenY = 170 * 3;

        gp.obj[22] = new OBJ_Kitchen("rocket-plush", "/rooms/bedroom/bedroom_OBJ/rocket-plush.png",11,17);
